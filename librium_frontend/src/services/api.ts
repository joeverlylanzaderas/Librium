...
export const softDeleteAuthor = (id: number) => req('DELETE', `/library/authors/${id}/`);
export const restoreAuthor = (id: number) => req('PATCH', `/library/authors/${id}/restore/`);
export const deleteAuthor  = (id: number) => req('DELETE', `/library/authors/${id}/`);

// ── Categories ────────────────────────────────────────────────
export const getCategories   = ()           => req('GET',  '/library/categories/');
export const getCategory     = (id: number) => req('GET',  `/library/categories/${id}/`);
...
export const softDeleteCategory = (id: number) => req('DELETE', `/library/categories/${id}/`);
export const restoreCategory = (id: number) => req('PATCH', `/library/categories/${id}/restore/`);
...
export const getDepartment     = (id: number) => req('GET',  `/library/departments/${id}/`);
...
export const softDeleteDepartment = (id: number) => req('DELETE', `/library/departments/${id}/`);
export const restoreDepartment = (id: number) => req('PATCH', `/library/departments/${id}/restore/`);
...
export const getSemester       = (id: number) => req('GET',   `/library/semesters/${id}/`);
...
export const getAuthorsWithDeleted = () => req('GET', '/library/authors/?include_deleted=true');
