...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      Alert.alert('Login failed', e?.data?.detail || 'Invalid credentials.');
    } finally {
      setLoading(false);
    }
  };
            ...
            <View style={s.card}>
              ...
              <View style={s.utilitiesRow}>
                ...
                <TouchableOpacity activeOpacity={0.7}>
                  <Text style={s.utilityLabel}>Forgot Password</Text>
                </TouchableOpacity>
              </View>

              {/* Hard Edged Crimson-Wood Tone Primary Call to Action */}
              <Btn
                label="SIGN IN"
                onPress={handleLogin}
                loading={loading}
              ...
              {/* Registration Alternative Hook */}
              <TouchableOpacity style={s.registerLink} activeOpacity={0.7}>
...
const s = StyleSheet.create({
  ...
  overlay: {
    ...
    backgroundColor: 'rgba(0, 0, 0, 0.15)', // Rich contrast setting
  },
  scrollContainer: {
    flexGrow: 1,
  ...
  logoText: {
    ...
    fontFamily: Fonts.gloock, // Uses Gloock Regular
    color: '#F4EFE0',
    fontWeight: '500',
    letterSpacing: 10,
    textAlign: 'center',
  ...
  quoteText: {
    fontFamily: Fonts.baskerville, // Uses Libre Baskerville Regular
    color: '#f3f1ed',
    fontSize: 13,
    textAlign: 'center',
    fontStyle: 'italic',
  ...
  card: {
    ...
    width: '100%',
    maxWidth: 390,
    borderRadius: 0, // Sharp crisp classic edges
    paddingHorizontal: 24,
    paddingTop: 42,
    paddingBottom: 24,
    shadowColor: '#000',
  ...
  submitButton: {
    backgroundColor: '#281711', // Dark elegant wood/cocoa tone from button mockup
